...
SENSOR_TYPES: Final = {
    ...
    # Soil sensors
    "soilmoisture1": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture2": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture3": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture4": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture5": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture6": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture7": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture8": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture9": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture10": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture11": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture12": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture13": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture14": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture15": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
    "soilmoisture16": {"name": "Soil Moisture", "unit": "%", "device_class": "moisture"},
...
BATTERY_SENSORS: Final = {
    "soilbatt1": {"name": "Battery", "sensor_key": "soilmoisture1"},
    "soilbatt2": {"name": "Battery", "sensor_key": "soilmoisture2"},
    "soilbatt3": {"name": "Battery", "sensor_key": "soilmoisture3"},
    "soilbatt4": {"name": "Battery", "sensor_key": "soilmoisture4"},
    "soilbatt5": {"name": "Battery", "sensor_key": "soilmoisture5"},
    "soilbatt6": {"name": "Battery", "sensor_key": "soilmoisture6"},
    "soilbatt7": {"name": "Battery", "sensor_key": "soilmoisture7"},
    "soilbatt8": {"name": "Battery", "sensor_key": "soilmoisture8"},
    "soilbatt9": {"name": "Battery", "sensor_key": "soilmoisture9"},
    "soilbatt10": {"name": "Battery", "sensor_key": "soilmoisture10"},
    "soilbatt11": {"name": "Battery", "sensor_key": "soilmoisture11"},
    "soilbatt12": {"name": "Battery", "sensor_key": "soilmoisture12"},
    "soilbatt13": {"name": "Battery", "sensor_key": "soilmoisture13"},
    "soilbatt14": {"name": "Battery", "sensor_key": "soilmoisture14"},
    "soilbatt15": {"name": "Battery", "sensor_key": "soilmoisture15"},
    "soilbatt16": {"name": "Battery", "sensor_key": "soilmoisture16"},
